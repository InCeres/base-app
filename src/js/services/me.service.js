...
baseServices.service('MeService', ['$rootScope', '$q', '$window', '$location', '$stateParams', 'AuthService', 'Redirect', 'Alert', 'Me', function ($rootScope, $q, $window, $location, $stateParams, AuthService, Redirect, Alert, Me) {
  var info = null;
  var loading = false;
