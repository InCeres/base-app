...
baseControllers.controller('LoginController', ['$rootScope', '$scope', '$window', '$location', '$state','$timeout', 'AuthService', 'Login',
...
baseControllers.controller('LogoutController', ['$rootScope', '$window', 'AuthService', 'Login', function($rootScope, $window, AuthService, Login) {
  AuthService.clear();
